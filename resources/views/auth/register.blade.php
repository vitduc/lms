...
<section class="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
            <form method="POST" action="{{ localized_route('register.store') }}" class="space-y-4">
                @csrf
            ...
            <div class="mt-6 pt-6 border-t border-gray-200">
                <p class="text-center text-gray-600 text-sm">
                    Đã có tài khoản?
                    <a href="{{ localized_route('login') }}" class="font-semibold text-purple-600 hover:text-purple-700">
                        Đăng nhập ngay
                    </a>
                </p>
            </div>
